            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="mb-4">
                        ...
                        <p class="text-muted mt-4 mb-2">support@blinc.africa</p>
                        <h6 class="text-muted font-weight-normal">+234 700 000 0000</h6>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="text-muted f-14">4806 Ewet Housing Estate</p>
                            <h6 class="text-muted pb-2">Email: support@blinc.africa</h6>
